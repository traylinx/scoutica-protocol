...
<AccordionGroup>
  ...
  **Cost comparison:**
  ...
  <Note>
  **The Anti-Spam Shield:** The micropayment layer (~$0.05 per Zone 2 access) is primarily designed to impose an economic cost on mass outreach. It eliminates spray-and-pray recruiter spam by guaranteeing candidates only hear from high-intent employers willing to pay to unlock their profile. (See the [Roadmap](/roadmap) for implementation details).
  </Note>
