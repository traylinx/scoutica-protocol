...
head:
  - tag: title
    content: "Scoutica Protocol — Your skills. Your rules. Your data."
---
...
<CardGroup cols={2}>
  <Card title="AI-powered generation" icon="wand-magic-sparkles">
    Drop your CV, certs, and portfolio in a folder. The CLI extracts them locally and asks your configured AI provider to generate the four card files. A remote-capable provider may receive the full generated prompt and document text.
  </Card>
