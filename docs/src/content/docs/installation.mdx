...
<Steps>
  <Step title="Run the installer">
    ...
    5. **Helper download:** Pulls the Python helpers the CLI shells out to — `scoring.py` (fit scoring), `import_aijs.py` (ai-job-search import), and `validate_card.py` (validation) — into `~/.scoutica/bin`.
